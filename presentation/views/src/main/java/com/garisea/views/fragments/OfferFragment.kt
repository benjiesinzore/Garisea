...
class OfferFragment : Fragment() {
    ...
    private var _fragmentBinding: FragmentOfferBinding? = null
    ...
    override fun onCreateView(
        ...
        _fragmentBinding = FragmentOfferBinding.inflate(inflater, container, false)
        val view = fragmentBinding.root

        val items = ParseJsonData(context).offersWrapper.items

        fragmentBinding.recycleViewOffers.layoutManager = LinearLayoutManager(context)

        val itemAdapter = ItemOffersAdapter(items)
        fragmentBinding.recycleViewOffers.adapter = itemAdapter
